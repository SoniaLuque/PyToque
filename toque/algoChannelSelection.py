...
def algoChannelSelection(left, right):
    ...
    ''' Algorithm which automatically selects the channel with
    non dominant vocals from a stereo flamenco recording
    based on spectral band energies as described in section 2-A-I of

    Adaptation of : Kroher, N. & Gomez, E. (2016). Automatic Transcription of Flamenco Singing from Polyphonic Music Recordings.
    ...
    :return: index of the dominant vocal channel (1 = left, 0 = right)
    '''
